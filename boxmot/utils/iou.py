...
### Summary of Changes:
1. Update the error message to provide more clarity on the valid function options.
2. Correct the spelling of "iou_batch" in the error message for consistency.
